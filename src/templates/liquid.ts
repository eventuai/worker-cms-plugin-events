...
//   - renderLiquid (no outputEscape): the server-side email/QR set
//     (templates/edm-mjml.liquid, layout/mjml.liquid, sections/mjml/*,
//     templates/qr.liquid). It embeds pre-sanitized HTML (safeHtml blocks) and
//     MJML attribute values that must reach the MJML compiler byte-identical;
//     those templates keep explicit `| escape` where needed.
//   - renderView (outputEscape: 'escape'): mirrors the HOST's browser renderer,
