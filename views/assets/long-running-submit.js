(function () {
  ...
  document.querySelectorAll('form[data-long-running-form]').forEach(function (form) {
    form.addEventListener('submit', function (event) {
      ...
      // Deferred one tick: the browser builds the POST body after this event
      // finishes, so disabling the submitter here would drop its name/value
      // (e.g. the archive form's action=apply/skip) from the submission.
      setTimeout(function () {
